...
public class CoinController : MonoBehaviour
{
    ...
    {
        // Check if it's still valid to collect a coin
        if (_gameManager.state != CurrentState.Ending && _gameManager.state != CurrentState.Ended)
        {
    ...
    private void DestroyCoin()
    {
        ...
        ObjectPooler.Instance.poolDictionary["Coin"].Enqueue(gameObject);
